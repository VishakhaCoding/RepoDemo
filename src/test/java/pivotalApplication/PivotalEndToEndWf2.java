...
public class PivotalEndToEndWf2 {
	AppiumDriver driver;
...
public void Search() throws InterruptedException {
	...
	SearchBar.sendKeys("PivoTotal10Automation");
...
public void DocumentsDropDown2() throws InterruptedException, IndexOutOfBoundsException {
	Thread.sleep(5000);
	List<WebElement> DocumentsDropDown2 = driver.findElements(By.className("android.widget.TextView"));
 ...
 * IndexOutOfBoundsException { Thread.sleep(5000); WebElement Save =
 * driver.findElement(By.xpath("//*[@text='Save']")); Save.click();
 * 
 * }
 */
@Test(priority = 43)
public void RefDownloadclose() throws InterruptedException, IndexOutOfBoundsException {
	Thread.sleep(10000);
	List<WebElement> RefDownloadclose
	  =  driver.findElements(By.className("android.widget.TextView"));
	RefDownloadclose.get(0).click();
	 Thread.sleep(5000);
	List<WebElement> Backward1 =
			 driver.findElements(By.className("android.widget.TextView"));
			 Backward1.get(0).click();
 ...
 */
	...
	public void Preview() throws InterruptedException, IndexOutOfBoundsException {
	  ...
	  @Test(priority = 84)
		...
		@Test(priority = 99)
		public void close5() throws InterruptedException, IndexOutOfBoundsException {
			Thread.sleep(2000);
			List<WebElement> close5 = driver
					.findElements(By.className("android.widget.TextView"));
			close5.get(2).click();
		}
}
