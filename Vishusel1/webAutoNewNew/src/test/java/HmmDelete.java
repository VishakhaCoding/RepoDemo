...
public class HmmDelete extends TestBase {
	 ...
	 LoginPage loginP;
	   ...
	   ProfileSummaryPage profileSummaryPage;
		 ...
		 * 
		 * loginP= new LoginPage(); searchPatientPage = new SearchPatientPage();
		 * profileSummaryPage = new ProfileSummaryPage(); homePage=new HomePage();
		 * vitalsPage= new VitalsPage(); chiefComplaints=new ChiefComplaints(); }
		 */
		/*
