...
//CertificateValid
	...
	public void FirstName() throws MalformedURLException, InterruptedException {
		...
		FirstName.get(0).sendKeys("BKHealth");
	...
	public void Time() throws MalformedURLException, InterruptedException {
		...
		List<WebElement> Time = driver.findElements(By.xpath("//*[@text='04:30 pm']"));
		Time.get(0).click();
	...
	public void PurposeVisit() throws MalformedURLException, InterruptedException {
		List<WebElement> NewVisit = driver.findElements(By.xpath("//*[@text='New Visit']"));
		...
		List<WebElement> CfSince = driver.findElements(By.className("android.widget.EditText"));
		...
		List<WebElement> CfVomitting = driver.findElements(By.xpath("//*[@text='Vomitting']"));
		CfVomitting.get(0).click();
		Thread.sleep(2000);

		List<WebElement> CfSince1 = driver.findElements(By.className("android.widget.EditText"));
	...
	public void photo() throws InterruptedException, IndexOutOfBoundsException {
		...
		driver.findElement(By.xpath(
				"//android.widget.LinearLayout[@content-desc=\"Screenshot_20231030-121635_Gallery.jpg, 717 kB, 30 Oct\"]"))
				.click();
