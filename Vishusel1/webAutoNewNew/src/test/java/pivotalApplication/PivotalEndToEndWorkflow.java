...
public class PivotalEndToEndWorkflow {
	AppiumDriver driver;
	  ...
	  @Test(priority = 13)
		public void FirstName() throws InterruptedException {
			...
			WebElement FirstName = driver.findElement(By.xpath("//*[@text='First Name']"));
			 FirstName.sendKeys("PivoTotal10Automation");
...
Haemoglobin.get(6).sendKeys("12"); Thread.sleep(5000);
...
public void Appointment() throws InterruptedException, IndexOutOfBoundsException {
  ...
  @Test(priority=80) public void SlotTime() throws InterruptedException {
...
public void prescription() throws InterruptedException, IndexOutOfBoundsException {
  ...
  @Test(priority=88) public void ComplaintAndDiagnosis() throws
  ...
  @Test(priority=89) public void AddChiefComplaints() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=90) public void Fever() throws InterruptedException,
  ...
  @Test(priority=91) public void Details() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=93) public void moreSymptoms() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=94) public void Since2Days() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=95) public void AddComplaint() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=96) public void AddWorkingDiagnosis() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=97) public void AcuteUrti() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> AddWorkingDiagnosis =
  ...
  @Test(priority=98) public void AddDiagnosis() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=99) public void Medicine() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=100) public void TapToAddMedicine() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=101) public void SearchMedDolo() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=102) public void AddToPrescription() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> AddToPrescription =
  driver.findElements(By.className("android.widget.TextView"));
  AddToPrescription.get(31).click(); }
  
  @Test(priority=103) public void ClickFavourite() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> ClickFavourite =
  driver.findElements(By.xpath("//*[@text='Favourite']"));
  ClickFavourite.get(0).click(); }
  
  @Test(priority=104) public void ClickFavoutiteDropdown() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> ClickFavoutiteDropdown =
  driver.findElements(By.className("android.widget.EditText"));
  ClickFavoutiteDropdown.get(0).click(); }
  
  @Test(priority=105) public void ClickFavoutiteMedDrp() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> ClickFavoutiteDropdown =
  driver.findElements(By.className("android.widget.TextView"));
  ClickFavoutiteDropdown.get(1).click(); }
  
  @Test(priority=106) public void ClickFavoutiteMedicine() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> ClickFavoutiteMedicine =
  driver.findElements(By.className("android.widget.TextView"));
  ClickFavoutiteMedicine.get(6).click(); }
  
  @Test(priority=107) public void CopyMedicine() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> CopyMedicine =
  driver.findElements(By.className("android.widget.TextView"));
  CopyMedicine.get(15).click(); }
  
  @Test(priority=108) public void popularClick() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  List<WebElement> popularClick =
  driver.findElements(By.xpath("//*[@text='Popular']"));
  popularClick.get(0).click(); }
  
  @Test(priority=109) public void popularMedicineClick() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=110) public void popularCopyMedicine() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
...
//}
  ...
  @Test(priority=111) public void DietAndNutrition() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  WebElement DietAndNutrition = driver.findElement(By.xpath("//*[@text='Diet & Nutrition']"));
  DietAndNutrition.click();

}
  @Test(priority=112) public void DietAndNutritionAdd() throws
  InterruptedException, IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=113) public void DietAdvice() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
  ...
  @Test(priority=114) public void AddDietAdvice() throws InterruptedException,
  IndexOutOfBoundsException{ Thread.sleep(2000);
...
@Test(priority = 124) public void SaveAndShare() throws InterruptedException,
 ...
 * }
 */
@Test(priority = 126) public void DownloadBack() throws InterruptedException,
IndexOutOfBoundsException { Thread.sleep(5000);

List<WebElement> DownloadCancel = driver
.findElements(By.xpath("//*[@text='Cancel']"));
...
public void VaccineLabel() throws InterruptedException, IndexOutOfBoundsException {
  ...
  @Test(priority = 133) public void PopUpOk() throws InterruptedException,
