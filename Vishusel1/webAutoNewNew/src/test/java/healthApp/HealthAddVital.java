...
public void AddVitals() throws MalformedURLException, InterruptedException {
	...
	/*
	 * List<WebElement> PulseText =driver.findElements(By.xpath(
	 * "//*[@text='Pulse']")); String s=PulseText.get(0).getText();
	 * System.out.print(s);
	 */
...
public void LipidProfile() throws MalformedURLException, InterruptedException {
	...
	driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"Save\").instance(0))"));
	Thread.sleep(10000);
