...
//			driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollIntoView(new UiSelector().text(\"Link Patient to Doctor")).click();
		...
		//driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollIntoView(new UiSelector().className(\"Link Patient to Doctor")).click();
		  
		/*
		 * MobileElement li=driver.findElement(MobileBy.
		 * AndroidUIAutomator("new UiScrollable(new UiSelector().scrollIntoView(new UiSelector().className(\"Link Patient to Doctor\");"
		 * ));li.click();
		 */
