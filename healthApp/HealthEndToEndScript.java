...
public class HealthEndToEndScript {
...
FirstName.get(0).sendKeys("FHealth");
...
public void Time() throws MalformedURLException, InterruptedException {
	...
	List<WebElement> Time =driver.findElements(By.xpath("//*[@text='05:40 pm']"
			));
	Time.get(0).click();
...
public void Done() throws MalformedURLException, InterruptedException {
	...
	public void AddButton1() throws MalformedURLException, InterruptedException {
		...
		List<WebElement> AddButton1 =driver.findElements(By.className(
				"android.widget.TextView"));
...
public void UploadDoc() throws MalformedURLException, InterruptedException {
	 ...
	 */
	  ...
	  Thread.sleep(5000);
	List<WebElement> AddButton2=driver.findElements(By.className(
			"android.widget.TextView"));
...
public void Done2() throws MalformedURLException, InterruptedException {
	...
	public void Birth() throws MalformedURLException, InterruptedException {
		...
		Birth.get(0).click();
		  ...
		  @Test(priority = 82) public void PopUpOk() throws InterruptedException,
		  ...
		  public void AddVitals() throws MalformedURLException, InterruptedException {
		  	...
		  	//Thread.sleep(10000);
		  	//driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(false).instance(0)).scrollIntoView(new UiSelector().textContains(\"Lipid Profile\").instance(0))"));
		  	Thread.sleep(10000);
